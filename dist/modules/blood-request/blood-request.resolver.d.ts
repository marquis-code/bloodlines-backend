...
export declare class BloodRequestResolver {
    ...
    getRequestById(user: any, requestId: string): Promise<import("mongoose").Document<unknown, {}, import("./schema/blood-request.schema").BloodRequest, {}, import("mongoose").DefaultSchemaOptions> & import("./schema/blood-request.schema").BloodRequest & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    }>;
    ...
    notifyDonorArrival(user: any, requestId: string): Promise<string>;
